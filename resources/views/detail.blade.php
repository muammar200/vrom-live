<x-front-layout>
        ...
        <section class="bg-darkGrey relative py-[70px]">
            <div class="container">
                ...
                <ul class="flex items-center gap-5 mb-[50px]">
                    <li
                        clasxs="text-secondary font-normal text-base capitalize after:content-['/'] last:after:content-none inline-flex gap-5">
        ...
        <section class="bg-darkGrey">
            <div class="container relative py-[100px]">
                ...
                @if(isset($noSimilarItemsMessage))
                    <p class="text-3xl font-bold text-center">{{ $noSimilarItemsMessage }}</p>
                @else
                <!-- Cars -->
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
                    ...
                    <div class="card-popular">
                        <div>
                            ...
                            <p class="text-sm font-normal text-secondary">{{ $similarItem->type->name }}</p>
